...
public class View {
	...
	private Map<Views, PaneSet> paneMap = new HashMap<Views, PaneSet>();
	private Map<MultiEntityViewType, PanePlusControl> multiEntityViews = new HashMap<PaneSet.MultiEntityViewType, PanePlusControl>();
