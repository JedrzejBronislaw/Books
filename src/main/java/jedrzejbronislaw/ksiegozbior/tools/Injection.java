...
public class Injection {
	...
	public static <RetrunType> RetrunType get(Supplier<RetrunType> supplier) {
		return get(supplier, null);
	}

	public static <RetrunType> RetrunType get(Supplier<RetrunType> supplier, RetrunType defaultValue) {
